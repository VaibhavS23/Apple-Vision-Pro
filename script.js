...
gsap.to(".herovideo", {
  ...
  onStart: () => {
    document.querySelector(".herovideo").play()
  }
})
gsap.to("#page", {
  scrollTrigger: {
...
function canvas() {
  const canvas = document.querySelector("#pg8>canvas");
...
const slide=document.querySelectorAll(".slidimg")
...
function canvas1(){
  const canvas = document.querySelector("#pg17>canvas");
const context = canvas.getContext("2d");
